...
<div class=" flex align-center">
  <div class=" card">
    ...
    <div class=" card-text">
      <p>There has been a password reset request. If you didn't request this, please disregard. This request is good for 10 minutes.</p>
...
const text =
  "There has been a password reset request. If you didn't request this, please disregard. This request is good for 10 minutes.\n" +
...
const params = {
  Template: {
    ...
    HtmlPart: html,
    SubjectPart: "You've requested a password reset.",
    TextPart: text,
  },
};
